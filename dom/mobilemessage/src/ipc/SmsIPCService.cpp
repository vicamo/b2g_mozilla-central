...
nsresult
SendRequest(PSmsChild* aSmsChild,
            ...
            nsIMobileMessageCallback* aRequestReply)
{
  ...
  aSmsChild->SendPSmsRequestConstructor(actor, aRequest);
  return NS_OK;
}

nsresult
SendCursorRequest(PSmsChild* aSmsChild,
                  ...
                  nsICursorContinueCallback** aResult)
{
  ...
  aSmsChild->SendPMobileMessageCursorConstructor(actor, aRequest);
...
SmsIPCService::GetSmsChild()
{
  ...
  if (!mSmsChild) {
    PSmsChild *child = ContentChild::GetSingleton()->SendPSmsConstructor();
    mSmsChild = static_cast<SmsChild*>(child);
  }
...
{
  return SendRequest(GetSmsChild(),
                     SendMessageRequest(SendSmsMessageRequest(nsString(aNumber),
                                                              nsString(aMessage))),
                     aRequest);
}
...
SmsIPCService::GetMessageMoz(int32_t aMessageId,
                             nsIMobileMessageCallback* aRequest)
{
  return SendRequest(GetSmsChild(), GetMessageRequest(aMessageId), aRequest);
}
                             ...
                             nsIMobileMessageCallback* aRequest)
{
  ...
  return SendRequest(GetSmsChild(), data, aRequest);
}
                                   ...
                                   nsICursorContinueCallback** aResult)
{
  ...
  return SendCursorRequest(GetSmsChild(),
...
{
  return SendRequest(GetSmsChild(),
                     MarkMessageReadRequest(aMessageId, aValue), aRequest);
}
...
{
  return SendCursorRequest(GetSmsChild(),
                           CreateThreadCursorRequest(), aCursorCallback,
                           aResult);
}
                    ...
                    nsIMobileMessageCallback *aRequest)
{
  ...
  return SendRequest(GetSmsChild(), SendMessageRequest(req), aRequest);
}

NS_IMETHODIMP
SmsIPCService::Retrieve(int32_t aId, nsIMobileMessageCallback *aRequest)
{
  return SendRequest(GetSmsChild(), RetrieveMessageRequest(aId), aRequest);
}
