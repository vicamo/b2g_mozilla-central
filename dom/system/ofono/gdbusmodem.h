...
#define OFONO_GDBUS_TYPE_MODEM_SKELETON (ofono_gdbus_modem_skeleton_get_type ())
#define OFONO_GDBUS_MODEM_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), OFONO_GDBUS_TYPE_MODEM_SKELETON, OfonoGDBusModemSkeleton))
#define OFONO_GDBUS_MODEM_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), OFONO_GDBUS_TYPE_MODEM_SKELETON, OfonoGDBusModemSkeletonClass))
#define OFONO_GDBUS_MODEM_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), OFONO_GDBUS_TYPE_MODEM_SKELETON, OfonoGDBusModemSkeletonClass))
#define OFONO_GDBUS_IS_MODEM_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), OFONO_GDBUS_TYPE_MODEM_SKELETON))
#define OFONO_GDBUS_IS_MODEM_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), OFONO_GDBUS_TYPE_MODEM_SKELETON))

typedef struct _OfonoGDBusModemSkeleton OfonoGDBusModemSkeleton;
typedef struct _OfonoGDBusModemSkeletonClass OfonoGDBusModemSkeletonClass;
typedef struct _OfonoGDBusModemSkeletonPrivate OfonoGDBusModemSkeletonPrivate;

struct _OfonoGDBusModemSkeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  OfonoGDBusModemSkeletonPrivate *priv;
};

struct _OfonoGDBusModemSkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType ofono_gdbus_modem_skeleton_get_type (void) G_GNUC_CONST;

OfonoGDBusModem *ofono_gdbus_modem_skeleton_new (void);
