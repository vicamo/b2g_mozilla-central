...
public:
  ...
  NS_OVERRIDE virtual bool RecvSendMessage(const nsString& aNumber, const nsString& aSMSC, const nsString& aMessage, const PRInt32& aRequestId, const PRUint64& aProcessId);
  NS_OVERRIDE virtual bool RecvSaveReceivedMessage(const nsString& aSender, const nsString& aSMSC, const nsString& aBody, const PRUint64& aDate, PRInt32* aId);
